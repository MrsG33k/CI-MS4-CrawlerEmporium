...
class Order(models.Model):
    ...
    order_id_string = models.CharField(max_length=20, unique=True, editable=False, blank=True, null=True)   # noqa: E501
    ...
    def __str__(self):
        return self.order_id_string if self.order_id_string else f"CRAWL{self.id}"   # noqa: E501
...
class OrderLineItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        to calculate line item pricing data records"""
